...
MBGeolocation is designed as a *universal Swift framework* with support for the following platforms within a single binary:
...
MBGeolocation uses **Swift 3.1** and **requires Xcode 8.3** to compile.
...
Once properly integrated, you can make use of [the API](https://rawgit.com/emaloney/MBGeolocation/master/Documentation/API/index.html) provided by MBGeolocation using the statement:
