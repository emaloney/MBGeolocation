...
```
github "emaloney/MBGeolocation" ~> 3.1.0
```

This specifies that Carthage use the latest version of MBGeolocation that is API-compatible with 3.1.0, i.e. any 3.1.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/emaloney/MBGeolocation/releases); there may be a newer version than 3.1.0 that is no longer API-compatible.
